...
const freePlanFeatures = ['Download product images 3 times per day', 'Get the best image quality', 'Save all images in one click', 'Save images as .ZIP file format']
const proPlanFeatures = ['Download product images unlimited', 'Get the best image quality', 'Save all images in one click', 'Save images as .ZIP file format']
