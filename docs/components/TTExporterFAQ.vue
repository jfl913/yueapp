          ...
          <div>
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                You can cancel your premium subscription at any time, just send
                an email to
                <a href="mailto:jfl913@gmail.com">jfl913@gmail.com</a> and tell
                us your account email.
              </p>
            </div>
          </div>
          <div>
            <div class="mb-10">
              ...
              <p class="text-gray-500 dark:text-gray-400">
                You can refund within 7 days, just send an email to
                <a href="mailto:jfl913@gmail.com">jfl913@gmail.com</a> and tell
                us your account email. You will receive your refund in the next
                few days.
              </p>
            </div>
          </div>
