                    ...
                    <div>
                        <div class="mb-10">
                            <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                ...
                                What can Follower Export Tool do for me?
                            </h3>
                            <p class="text-gray-500 dark:text-gray-400">1. One-click to Export followers from Instagram to csv </p>
                            <p class="text-gray-500 dark:text-gray-400">2. One-click to Export following list from Instagram to csv</p>
                            <p class="text-gray-500 dark:text-gray-400">3. Extract user profile</p>
                        </div>
                        <div class="mb-10">
                            <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                <svg class="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
