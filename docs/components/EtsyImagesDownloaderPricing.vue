...
const freePlanFeatures = ['Download product images/videos 3 times per day', 'Get the best image quality', 'Save all images in one click', 'Save images as .ZIP file format']
const proPlanFeatures = ['Download product images unlimited', 'Get the best image quality', 'Save all images in one click', 'Save images as .ZIP file format', 'Download product videos unlimited']
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div class="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-6 lg:space-y-0">
                    ...
                    <div
                        ...
                        <div class="flex justify-center items-baseline my-8">
                            <span class="mr-2 text-5xl font-extrabold">$87.99</span>
